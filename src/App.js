...
function App() {
  ...
  const claimNFTs = () => {
    ...
    let totalGasLimit = String(140000);
  ...
  useEffect(() => {
    ...
    const endTime = new Date("2023-01-22T10:30:00Z");
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              Burn Bridge token and get your art inscribed to BITCOIN via Ordinals Protocol.
            </s.TextDescription>
